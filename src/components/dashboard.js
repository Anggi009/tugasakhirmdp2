...
import StyledBloc from './styledbloc/Countries';
import CovidData from './CovidData/CovidData';
import StyledCovid from './styledcovid/Countries';
  ...
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      ...
      <Link color="inherit" href="https://material-ui.com/">
        Praktikum Mobile Devices Programming
      </Link>{' '}
    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Switch>
          ...
          <Route path="/RegionBloc/:regionbloc" component={StyledBloc} />
          <Route path="/CovidData/:alpha2Code" component={CovidData} />
          <Route path="/StyledCovid" component={StyledCovid} />
